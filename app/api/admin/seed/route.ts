...
import { seedAdminTables, dbCreateAdmin, dbGetAdminByEmail, dbSeedDefaultServices, dbSeedDefaultProjects, dbSeedDefaultTestimonials } from '@/lib/admin-db';
...
export async function POST() {
  try {
    ...
    await dbSeedDefaultTestimonials();
